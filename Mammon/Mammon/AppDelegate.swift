...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupAuthenticatedAwsCognito() {
        ...
        let configuration = AWSCognitoIdentityUserPoolConfiguration(
            clientId: Utils.getAppConfigProperty(category: "aws", key: "aws_client_id"),
            clientSecret: Utils.getAppConfigProperty(category: "aws", key: "aws_client_secret"),
            poolId: Utils.getAppConfigProperty(category: "aws", key: "aws_cognito_userpool_id")
        )
